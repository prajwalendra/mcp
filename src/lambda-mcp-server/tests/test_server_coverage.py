...
class TestFormatLambdaResponseCoverage:
    ...
    def test_format_lambda_response_variants(self):
        ...
        assert "Function test-function returned: {}" in format_lambda_response('test-function', b'{}')
...
class TestRegisterLambdaFunctionsCoverage:
    ...
    def test_register_with_incomplete_tag_config(self, mock_create_lambda_tool, mock_lambda_client, caplog):
    ...
    @patch('awslabs.lambda_mcp_server.server.create_lambda_tool')
    def test_register_with_incomplete_tag_config_reversed(self, mock_create_lambda_tool, mock_lambda_client, caplog):
