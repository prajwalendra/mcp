...
class MissingCredentialsError(AuthError):
    ...
    def __init__(self, message: str, details: Optional[Dict] = None):
        ...
        Args:
            ...
            details: Additional error details
        """
        super().__init__(message=message, error_type=AuthErrorType.MISSING_CREDENTIALS, details=details)
...
class InvalidCredentialsError(AuthError):
    ...
    def __init__(self, message: str, details: Optional[Dict] = None):
        ...
        Args:
            ...
            details: Additional error details
        """
        super().__init__(message=message, error_type=AuthErrorType.INVALID_CREDENTIALS, details=details)
...
class InsufficientPermissionsError(AuthError):
    ...
    def __init__(self, message: str, details: Optional[Dict] = None):
        ...
        Args:
            ...
            details: Additional error details
        """
        super().__init__(message=message, error_type=AuthErrorType.INSUFFICIENT_PERMISSIONS, details=details)
...
class ConfigurationError(AuthError):
    ...
    def __init__(self, message: str, details: Optional[Dict] = None):
        ...
        Args:
            ...
            details: Additional error details
        """
        super().__init__(message=message, error_type=AuthErrorType.CONFIGURATION_ERROR, details=details)
...
def format_error_message(
    provider_name: str, error_type: AuthErrorType, message: str
) -> str:
