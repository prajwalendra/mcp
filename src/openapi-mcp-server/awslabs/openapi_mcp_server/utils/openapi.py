            ...
            with open(spec_path, "r") as f:
                ...
                try:
                    ...
                    try:
                        ...
                        raise ImportError("Required dependency 'pyyaml' not installed. Install it with: pip install pyyaml")
                    except Exception as e:
                        logger.error(f"Failed to parse OpenAPI spec file as YAML: {path} - Error: {e}")
                        raise
        except Exception as e:
