...
class TestRegisterAuthProviders:
    ...
    def test_register_auth_providers_no_env(self):
        ...
        with patch('awslabs.openapi_mcp_server.auth.register.register_all_providers') as mock_register_all:
    ...
    def test_register_auth_providers_with_env(self):
        ...
        with patch('awslabs.openapi_mcp_server.auth.register.register_provider_by_type') as mock_register_by_type:
    ...
    def test_register_provider_by_type_bearer(self):
        ...
        with patch('awslabs.openapi_mcp_server.auth.register.register_auth_provider') as mock_register:
